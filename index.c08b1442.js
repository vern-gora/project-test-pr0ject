...
<p class="modal-submit-text is-hidden">
  ...
  delete, press the button “Remove from the shopping list”.
      ...
      </div>`).join("");p.style.display="none",g.innerHTML=o;let a=document.querySelectorAll(".see-more");a.forEach(e=>{e.addEventListener("click",e=>{let t=e.currentTarget;v=t.dataset.category,(0,n.searchCategory)(v).then(e=>f(e,g,v))})})}(e)}).catch(e=>{console.log(e)})}let v="";function f(e,o){p.style.display="block";let a=`<h2 class="category-name-heading" id="category-heading">${v}</h2><div class="test">`+e.map(({author:e,image:o,title:a,id:i})=>o?`<div class="home-card" data-id="${i}"  data-action="open-modal">
                <img src="${o}" alt="${a}" class="home-book-image">
                <h2 class="home-book-title">${a}</h2>
                <h3 class="home-book-author">${e}</h3>
