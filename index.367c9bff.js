...
<p class="modal-submit-text is-hidden">
  ...
  delete, press the button “Remove from the shopping list”.
        ...
        <div class="home-category-block">
          ...
          <button class="see-more" data-category="${e}">See more</button>
      ...
      </div>`).join("");y.style.display="none",E.innerHTML=o;let a=document.querySelectorAll(".see-more");a.forEach(e=>{e.addEventListener("click",e=>{let t=e.currentTarget;$=t.dataset.category,(0,r.searchCategory)($).then(e=>x(e,E,$))})})}(e)}).catch(e=>{console.log(e)})}let $="";function x(e,o){y.style.display="block";let a=`<h2 class="category-name-heading" id="category-heading">${$}</h2><div class="test">`+e.map(({author:e,image:o,title:a,id:i})=>o?`<div class="home-card" data-id="${i}"  data-action="open-modal">
                <img src="${o}" alt="${a}" class="home-book-image">
                <h2 class="home-book-title">${a}</h2>
                <h3 class="home-book-author">${e}</h3>
            ...
            <h2 class="home-book-title">${a}</h2>
            <h3 class="home-book-author">${e}</h3>
            </li>`).join("");o.innerHTML=a;let i=document.getElementById("category-heading"),l=i.textContent.split(" "),s=l.pop(),r=l.join(" ")+' <span class="books-design">'+s+"</span>";i.innerHTML=r}var r=l("b7ONl");let H=document.querySelector(".categories-list"),_=document.querySelector(".book-list");function w(e){let t=document.querySelector(".categories-el.active");t&&t.classList.remove("active"),e.classList.add("active")}fetch("https://books-backend.p.goit.global/books/category-list").then(e=>{if(e.ok)return e.json();throw Error("Ошибка при выполнении запроса: "+e.status)}).then(e=>{if(Array.isArray(e)){let t=e.map(e=>e.list_name),o=document.querySelector(".categories-title");o.addEventListener("click",()=>{w(o),k()}),t.forEach((e,t)=>{let o=document.createElement("li");o.textContent=e,o.classList.add("categories-el"),H.appendChild(o),o.addEventListener("click",e=>{let t=e.target;w(t);let o=t.textContent;(0,r.searchCategory)(o).then(e=>x(e,_))})})}})}();
//# sourceMappingURL=index.367c9bff.js.map
